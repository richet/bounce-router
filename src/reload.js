...
function writeOrders({session, root, bus, grant, profiles = {}, orchestrator}) {
  ...
  fs.writeFileSync(file, [
    ...
    'reply means it expired, not that the task ended — wait again or end your turn: when a task you submitted ends while you are',
    'idle, bounce starts your next turn itself with the outcome (a `handoff` row in the journal), so you never need to poll.',
